...
### IAV model with log epochs & recall precision ###
#########################################
...
plt.title('ROC Curve for IAV Model')
plt.legend(loc="lower right")
plt.savefig(results_dir / 'iav_model_roc_auc.png')
plt.show()
...
plt.title('Confusion Matrix for IAV Model')
plt.xticks(rotation=45, ha='right')  # Rotate x-axis labels
plt.yticks(rotation=45, ha='right')  # Rotate y-axis labels
plt.tight_layout()  # Adjust layout to prevent clipping of labels
plt.savefig(results_dir / 'iav_model_confusion_matrix.png')
plt.show()
...
plt.tight_layout()
plt.savefig(results_dir / 'iav_model_training_metrics.png')
plt.show()
